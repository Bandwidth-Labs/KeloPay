...
import { sepolia, liskSepolia, arbitrumSepolia, bscTestnet, lisk, arbitrum, base, bsc, mainnet, baseSepolia } from "@reown/appkit/networks";
...
const mainnetNetworks: [AppKitNetwork, ...AppKitNetwork[]] = [mainnet, lisk, arbitrum, base, bsc]
...
const metadata = {
  name: "KeloPay",
  description: `KeloPay - Bridging Crypto to Real-World Payments - ${isMainnet ? 'Mainnet' : 'Testnet'} Mode`,
  url: "https://www.kelopay.com", // Replace with your actual domain
  icons: ["https://www.kelopay.com/logo.png"], // Replace with your actual logo URL
};
...
createAppKit({
  ...
  features: {
    ...
    socials: ["google", "x", "github", "discord", "apple", "facebook", "farcaster"], // Enable social sign-in
